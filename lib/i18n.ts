...
export const translations = {
  en: {
    ...
    home: {
      ...
      doctorsDesc: "Join as a doctor to support mothers with professional advice alongside AI guidance.",
      ...
      trustedPlatform: "Trusted Pregnancy Support Platform",
      riskDetectionTool: "Risk Detection Tool (Works Offline)",
      goToDashboard: "Go to Dashboard",
      getStartedAsMother: "Get Started as a Mother",
      iAmHealthWorker: "I am a health worker",
      freeAISupport: "Free AI support 24/7 • No credit card required • Instant answers anytime",
      whyChoose: "Why Choose MomsCare AI?",
      supportDescription: "24/7 AI-powered support for every step of your pregnancy journey",
      aiPoweredIntelligence: "AI-Powered Intelligence",
      aiIntelligenceDesc: "Get instant, personalized pregnancy guidance powered by advanced AI — available anytime, anywhere.",
      optionalExpertConsultations: "Optional Expert Consultations",
      expertConsultationsDesc: "Connect with verified doctors when you need professional medical advice alongside AI guidance.",
      secureHealthTracking: "Secure Health Tracking",
      healthTrackingDesc: "Track your pregnancy progress, store prescriptions securely, and maintain your health records in one place.",
      getStartedTitle: "Get Started Today",
      getStartedDesc: "Get instant AI support now, or register for personalized features",
      freeFeatures: "Free AI support 24/7 • Track your pregnancy • Upload prescriptions",
      features: "Features",
    },
    // Mother Dashboard
    mother: {
  ...
  bn: {
    ...
    home: {
      ...
      trustedPlatform: "বিশ্বস্ত গর্ভাবস্থা সহায়তা প্ল্যাটফর্ম",
      riskDetectionTool: "ঝুঁকি সনাক্তকরণ সরঞ্জাম (অফলাইনে কাজ করে)",
      goToDashboard: "ড্যাশবোর্ডে যান",
      getStartedAsMother: "মা হিসাবে শুরু করুন",
      iAmHealthWorker: "আমি একজন স্বাস্থ্যকর্মী",
      freeAISupport: "বিনামূল্যে AI সহায়তা ২৪/৭ • ক্রেডিট কার্ডের প্রয়োজন নেই • যেকোনো সময় তাৎক্ষণিক উত্তর",
      whyChoose: "কেন MomsCare AI বেছে নেবেন?",
      supportDescription: "আপনার গর্ভাবস্থার যাত্রার প্রতিটি ধাপে ২৪/৭ AI-চালিত সহায়তা",
      aiPoweredIntelligence: "AI-চালিত বুদ্ধিমত্তা",
      aiIntelligenceDesc: "উন্নত AI দ্বারা চালিত তাৎক্ষণিক, ব্যক্তিগতকৃত গর্ভাবস্থা নির্দেশনা পান — যেকোনো সময়, যেকোনো জায়গায় উপলব্ধ।",
      optionalExpertConsultations: "ঐচ্ছিক বিশেষজ্ঞ পরামর্শ",
      expertConsultationsDesc: "AI নির্দেশনার পাশাপাশি পেশাদার চিকিৎসা পরামর্শের প্রয়োজন হলে যাচাইকৃত ডাক্তারদের সাথে সংযুক্ত হন।",
      secureHealthTracking: "নিরাপদ স্বাস্থ্য ট্র্যাকিং",
      healthTrackingDesc: "আপনার গর্ভাবস্থার অগ্রগতি ট্র্যাক করুন, প্রেসক্রিপশন নিরাপদে সংরক্ষণ করুন এবং আপনার স্বাস্থ্য রেকর্ড এক জায়গায় রাখুন।",
      getStartedTitle: "আজই শুরু করুন",
      getStartedDesc: "এখনই তাৎক্ষণিক AI সহায়তা পান, বা ব্যক্তিগতকৃত বৈশিষ্ট্যের জন্য নিবন্ধন করুন",
      freeFeatures: "বিনামূল্যে AI সহায়তা ২৪/৭ • আপনার গর্ভাবস্থা ট্র্যাক করুন • প্রেসক্রিপশন আপলোড করুন",
      features: "বৈশিষ্ট্য",
    },
    // Mother Dashboard
    mother: {
