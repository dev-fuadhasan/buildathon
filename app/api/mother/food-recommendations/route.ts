...
export async function POST(req: NextRequest) {
  try {
    ...
    const recommendation = {
      ...
      dinner: routineData.dinner,
      exercises: routineData.exercises,
      waterIntake: routineData.waterIntake || existing?.waterIntake || "Drink 8-10 glasses (2-2.5 liters) of water throughout the day. Increase intake if in hot climate or after exercise. Drink water between meals, not during meals.",
